...
export const countryProfiles: Record<string, CountryProfile> = {
  ...
  JPN: { popularity: 88, youthCompetition: 84, coachingQuality: 86, facilityQuality: 90, internationalExposure: 85, technicalBias: { defense: 2, receive: 2 } },
  ...
  KOR: { popularity: 84, youthCompetition: 86, coachingQuality: 87, facilityQuality: 84, internationalExposure: 86, technicalBias: { drive: 2, defense: 2 } },
